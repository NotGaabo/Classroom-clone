...
-- Root cause found with Supabase CLI/local logs:
-- the old trigger function used new.user_metadata, but auth.users has
-- raw_user_meta_data. This replaces the broken Auth profile triggers.
